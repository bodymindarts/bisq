...
public class EditOfferView extends MutableOfferView<EditOfferViewModel> {
    ...
    @Inject
    private EditOfferView(EditOfferViewModel model, Navigation navigation, Preferences preferences, Transitions transitions, OfferDetailsWindow offerDetailsWindow, ImmutableCoinFormatter btcFormatter, BsqFormatter bsqFormatter) {
