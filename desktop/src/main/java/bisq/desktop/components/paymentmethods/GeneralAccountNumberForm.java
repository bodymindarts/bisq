...
abstract public class GeneralAccountNumberForm extends PaymentMethodForm {
    ...
    GeneralAccountNumberForm(PaymentAccount paymentAccount, AccountAgeWitnessService accountAgeWitnessService, InputValidator inputValidator, GridPane gridPane, int gridRow, ImmutableCoinFormatter formatter) {
